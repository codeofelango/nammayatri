...
type GetMerchantServiceUsageConfig = (ApiAuth 'DRIVER_OFFER_BPP_MANAGEMENT 'MERCHANT 'SERVICE_USAGE_CONFIG :> API.Types.RiderPlatform.Management.Merchant.GetMerchantServiceUsageConfig)
