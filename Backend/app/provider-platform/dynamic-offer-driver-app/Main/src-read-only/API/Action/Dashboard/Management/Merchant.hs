...
postMerchantServiceConfigVerificationUpdate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantServiceConfigVerificationUpdate a3 a2 a1
...
postMerchantConfigOperatingCityCreate a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantConfigOperatingCityCreate a3 a2 a1
...
postMerchantSpecialLocationUpsert a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantSpecialLocationUpsert a4 a3 a2 a1
...
deleteMerchantSpecialLocationDelete a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.deleteMerchantSpecialLocationDelete a3 a2 a1
...
postMerchantSpecialLocationGatesUpsert a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.postMerchantSpecialLocationGatesUpsert a4 a3 a2 a1
...
deleteMerchantSpecialLocationGatesDelete a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Merchant.deleteMerchantSpecialLocationGatesDelete a4 a3 a2 a1
