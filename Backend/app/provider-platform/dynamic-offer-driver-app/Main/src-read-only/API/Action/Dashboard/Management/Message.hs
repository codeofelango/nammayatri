...
import qualified Domain.Action.Dashboard.Message as Domain.Action.Dashboard.Message
...
postMessageUploadFile a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.postMessageUploadFile a3 a2 a1
...
postMessageAddLink a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.postMessageAddLink a3 a2 a1
...
postMessageAdd a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.postMessageAdd a3 a2 a1
...
postMessageSend a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.postMessageSend a3 a2 a1
...
getMessageList a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.getMessageList a4 a3 a2 a1
...
getMessageInfo a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.getMessageInfo a3 a2 a1
...
getMessageDeliveryInfo a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.getMessageDeliveryInfo a3 a2 a1
...
getMessageReceiverList a7 a6 a5 a4 a3 a2 a1 = withFlowHandlerAPI $ Domain.Action.Dashboard.Message.getMessageReceiverList a7 a6 a5 a4 a3 a2 a1
