...
getTicketBookingList (_, merchantId') mbLimit mbOffset placeId mbTicketBookinShordId mbTicketBookingServiceId mbTicketBookingStatus mbFrom mbTo = do
  ...
  ticketBookingList <- case mbTicketBookingServiceId of
    Nothing -> do
      ticketBookingList <- QTB.findAllTicketBookingList merchantOpCity.id mbLimit mbOffset mbFrom mbTo placeId mbTicketBookinShordId ((Kernel.Prelude.read . Data.Text.unpack) <$> mbTicketBookingStatus)
      mapM mTicketBookingList ticketBookingList
    Just ticketBookingServiceId -> do
      ticketBookingServiceList <- QTBS.findAllTicketBookingServiceList merchantOpCity.id mbLimit mbOffset mbFrom mbTo ticketBookingServiceId mbTicketBookinShordId ((Kernel.Prelude.read . Data.Text.unpack) <$> mbTicketBookingStatus)
