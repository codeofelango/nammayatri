...
import Storage.Beam.TicketBooking
import Storage.Beam.TicketBookingService
  ...
  B.defaultDbSettings
    `B.withDbModification` B.dbModification
      { exophone = exophoneTable,
        ...
        rating = ratingTable,
        ticketBooking = ticketBookingTable,
        tickekBookingService = ticketBookingServiceTable
      }
...
data AtlasDB f = AtlasDB
  { exophone :: f (B.TableEntity ExophoneT),
    ...
    ticketBooking :: f (B.TableEntity TicketBookingT),
    tickekBookingService :: f (B.TableEntity TicketBookingServiceT)
  }
