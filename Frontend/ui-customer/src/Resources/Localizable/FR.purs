...
getFR stringKey =
    case stringKey of
        ...
        BOOK_A_ROUND_TRIP -> "Réservez un voyage aller-retour pour avoir un taxi et un chauffeur à votre service pour la distance et le temps prévu, idéal pour vos besoins de voyage interurbains."
