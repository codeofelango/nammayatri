...
getKN stringKey =
    case stringKey of
        ...
        WELCOME_TEXT _ -> "ನಮ್ಮ ಯಾತ್ರಿಗೆ ಸುಸ್ವಾಗತ"
        ...
        WAITING_CHARGE_DESCRIPTION -> "°ಮೊದಲ 3 ನಿಮಿಷಗಳವರೆಗೆ ಕಾಯುವ ಶುಲ್ಕ ಶೂನ್ಯವಾಗಿರುತ್ತದೆ. ಅದರ ನಂತರ ನೀವು ಕಾಯುವ ಸಮಯಕ್ಕೆ ಪ್ರತಿ ನಿಮಿಷಕ್ಕೆ ₹2 ಶುಲ್ಕ ವಿಧಿಸಲಾಗುತ್ತದೆ."
        WAITING_CHARGE_RATECARD_DESCRIPTION -> "1. ಮೊದಲ 3 ನಿಮಿಷಗಳವರೆಗೆ ಕಾಯುವ ಶುಲ್ಕ ಶೂನ್ಯವಾಗಿರುತ್ತದೆ.\n 2. ಪ್ರತಿ ನಿಮಿಷಕ್ಕೆ ₹2 ವೇಟಿಂಗ್ ಚಾರ್ಜ್ ನಂತರ ಅನ್ವಯಿಸುತ್ತದೆ."
        FARE_POLICY_WAITING_CHARGES -> "ಮೊದಲ 3 ನಿಮಿಷಗಳ ಕಾಯುವಿಕೆಯ ನಂತರ ಪ್ರತಿ ನಿಮಿಷಕ್ಕೆ @ ₹2 ಅನ್ವಯಿಸುತ್ತದೆ"
        ...
        MOST_LOVED_APP _  -> "ಹೆಚ್ಚು ❤️ ಆಟೋ ಅಪ್ಲಿಕೇಶನ್"
        PICKUP_  -> "ಪಿಕಪ್-> "
        ...
        SHARE_INFO_WITH_EMERGENCY_CONTACTS_TITLE -> "ಮಾಹಿತಿ ಹಂಚಿಕೊಳ್ಳಿ ಮತ್ತು ಆಪಾತ ಸಂಪರ್ಕಗಳೊಡನೆ ಸ್ವಯಂಛಾಯಾ ಕಾಲ್ ಪ್ರಾರಂಭಿಸಿ?"
        ...
        WHO_CAN_TRACK_YOUR_RIDE _ -> "ನಮ್ಮ ಯಾತ್ರಿ ಆಪ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಯಾತ್ರೆಯನ್ನು ಅನುಸರಿಸಬಹುದು ಯಾರು"
        ...
        EMERGENCY_CONTACTS_CAN_FOLLOW _ -> "ನಮ್ಮ ಯಾತ್ರಿ ಅಪ್ಲಿಕೇಶನ್‌ನಲ್ಲಿ ನಿಮ್ಮ ಆಪಾತ ಸಂಪರ್ಕಗಳು ಆಪಾತ ಪ್ರತಿಕ್ರಿಯಾ ಕಾರ್ಯಗಳನ್ನು ಹೊಂದಿಕೊಳ್ಳಬಹುದು"
        ALERT_SAFETY_TEAM _ -> "ನಮ್ಮ ಯಾತ್ರಿ ಸುರಕ್ಷಾ ತಂಡಕ್ಕೆ ಎಚ್ಚರಿಕೆ ನೀಡಿ"
        OPTION_TO_REPORT_A_SAFETY_ISSUE -> "ಸುರಕ್ಷಾ ಸಮಸ್ಯೆಯನ್ನು ವರದಿಯಿರಿ ಆಯ್ಕೆ"
        RECOMMEND_EMERGENCY_CONTACTS_TO_INSTALL _ -> "ನಾವು ಆಪಾತ್ಕಾಲಿಕ ಸಂಪರ್ಕಗಳಿಗೆ ನಮ್ಮಯಾತ್ರಿ ಅನುಸ್ಥಾಪಿಸಲು ಸೂಚಿಸುತ್ತಾರೆ ಹೆಚ್ಚಿನ ಟ್ರ್ಯಾಕಿಂಗ್ ಅನುಭವಕ್ಕಾಗಿ"
        ...
        SAFETY_TEAM_WILL_BE_ALERTED _ -> "ಆಪತ್ಕಾಲದಲ್ಲಿ, ನಮ್ಮ ಯಾತ್ರಿ ಸುರಕ್ಷಾ ತಂಡಕ್ಕೆ ಅವಗಾಹನವಾಗುತ್ತದೆ"
        EMERGENCY_CONTACTS_CAN_TAKE_ACTION -> "ಆಪತ್ಕಾಲದಲ್ಲಿ, ಆಪತ್ಕಾಲ ಪ್ರತಿಕ್ರಿಯಾ ಕ್ರಿಯೆಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳಲು ಆಪಾತ ಸಂಪರ್ಕಗಳು ನಮ್ಮ ಯಾತ್ರಿ ಆಪ್ಲಿಕೇಶನ್‌ನಲ್ಲಿ ಅನುಸರಿಸಬಹುದು"
        SHARE_RIDE -> "ಪ್ರಯಾಣ ಹಂಚಿಕೊಳ್ಳಿ"
        SHARE_RIDE_DESCRIPTION _ -> "ಇದನ್ನು ಆರಿಸುವುದರೊಂದಿಗೆ ನಮ್ಮ ಯಾತ್ರಿ ಆಪ್ ಪುಶ್ ಅಧಿಸೂಚನೆಯನ್ನು ಆಪತ್ತಿನ ಕಾಂಟಾಕ್ಟ್‌ಗಳಿಗೆ ಕಳುಹಿಸುತ್ತದೆ"
        ...
        PLEASE_STAY_CALM_TEAM_ALERTED _ -> "ದಯವಿಟ್ಟು ಶಾಂತವಾಗಿರಿ, ನಮ್ಮ ಯಾತ್ರಿ ಸುರಕ್ಷಾ ತಂಡಕ್ಕೆ ಅಲರ್ಟ್ ಹೊಂದಿದೆ!"
        ...
        PRESS_THE_BUTTON_ON_EMERGENCY -> "ಆಪತ್ಕಾಲ ಎಸ್ ಓ ಎಸ್ ಬಟನ್ ಮೇಲೆ ಟ್ಯಾಪ್ ಮಾಡಿ"
        ...
        INDICATION_TO_EMERGENCY_CONTACTS _ -> "ನಿಮ್ಮ ಆಪಾತ ಸಂಪರ್ಕಗಳಿಗೆ ಇದು ಪರೀಕ್ಷಣ ಎಂದು ಸೂಚಿಸುತ್ತದೆ, ದುಃಖರಹಿತ ಅನುಭವವನ್ನು ಖಚಿತಪಡಿಸುತ್ತದೆ."
