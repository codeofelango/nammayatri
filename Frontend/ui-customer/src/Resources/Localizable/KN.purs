...
getKN stringKey =
    case stringKey of
        ...
        GO_HOME_ -> "ಮನೆಗೆ ಹೋಗಿ"
        ABOUT_APP_DESCRIPTION -> "{} ಸವಾರರನ್ನು ಚಾಲಕರೊಂದಿಗೆ ಸಂಪರ್ಕಿಸಲು ಮುಕ್ತ ವೇದಿಕೆಯಾಗಿದೆ. ಮೀಟರ್ ದರದೊಂದಿಗೆ ಸವಾರಿಯನ್ನು ಕಾಯ್ದಿರಿಸಲು ಸವಾರರಿಗೆ ಅಪ್ಲಿಕೇಶನ್ ಅನುಕೂಲಕರವಾಗಿದೆ ಆದ್ದರಿಂದ ಕನಿಷ್ಠ ಶುಲ್ಕ"
        ABOUT -> "ಬಗ್ಗೆ"
        ...
        DAYTIME_CHARGES_APPLIED_AT_NIGHT from till -> "x ಅನ್ನು ರಾತ್ರಿಯ ದರಕ್ಕೆ ಅನ್ವಯಿಸಲಾಗುತ್ತದೆ"
        ...
        TOLL_CHARGES_WILL_BE_EXTRA -> "ಅನ್ವಯವಾಗುವ ಟೋಲ್ ಶುಲ್ಕಗಳನ್ನು ದರಗಳಲ್ಲಿ ಸೇರಿಸಲಾಗಿದೆ"
