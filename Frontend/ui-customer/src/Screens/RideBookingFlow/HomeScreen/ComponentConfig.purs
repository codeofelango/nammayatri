      ...
      map
        ...
        ( [ { image: "ny_ic_instant", text: (getString INSTANT), id: "INSTANT", background: Color.lightMintGreen, showBanner: GONE }
          , { image: "ny_ic_rental", text: (getString RENTALS_), id: "RENTALS", background: Color.moonCreme, showBanner: GONE }
            ...
            <> if state.data.currentCityConfig.enableIntercityBus then [ { image: "ny_ic_intercity_bus", text: (getString INTER_CITY_BUS), id: "INTER_CITY_BUS", background: Color.blue600', showBanner: GONE } ] else []
        )
  in
    { tagList: locTagList }
