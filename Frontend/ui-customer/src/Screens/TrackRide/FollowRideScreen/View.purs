...
getChatHeight state =
  let srcAndDstBounds = runFn1 getLayoutBounds $ getNewIDWithTag "FollowRideSourceDestinationView"
  in getPeekHeight state + getDefaultPixelSize srcAndDstBounds.height