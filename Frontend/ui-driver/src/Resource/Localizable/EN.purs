...
getEN stringKey =
    case stringKey of
        ...
        SEVEN_DAY_FREE_TRIAL_ACTIVATED days -> days <> "-Day FREE TRIAL Activated!"
        TAKE_UNLIMITED_RIDES_FOR_THE_NEXT_SEVEN_DAYS days -> "Take unlimited rides for the first " <> days <> " days"
        ...
        FREE_TRIAL_REMINDER days -> "Day " <> days <> ": FREE TRIAL reminder"
        PLAN_STARTS days -> "Day " <> days <> ": Plan Starts"
        ...
        YATRI_COINS_FAQS_QUES2_ANS1 _ -> "Yatri Coins are valid for a period of 90 days from the day they are earned. During this period, you can use the coins for availing benefits."
        YATRI_COINS_FAQS_QUES2_ANS2 _ -> "Yatri Coins not redeemed within 90 days stand forfeited"
