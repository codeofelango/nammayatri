...
getEN stringKey =
    case stringKey of
        ...
        VEHICLE_REGISTRATION_NUMBER _ -> "Vehicle Registration Certificate Number"
        RE_ENTER_VEHICLE_REGISTRATION_NUMBER _ -> "Re-enter Vehicle Registration Certificate Number"
        ...
        AND -> " and "
        DIRECT_PAYMENT_NO_COMMISSIONS _-> "Direct payment.\nNo commissions"
        CUSTOMER_PAYS_DIRECTLY _-> "Customer pays to you directly"
        HUNDRED_PERCENT_FARE_GOES_TO_YOU _-> "100% of the fare\ngoes to you!"
        FARE_SHOWN_IS_FARE_YOU_GET _ -> "The fare shown is the fare you get.\nNo hidden charges."
        BE_A_PART_OF_OPEN_MOBILITY_REVOLUTION _ -> "Be a part of the Open\nMobility Revolution!"
        OUR_DATA_AND_PRODUCT_ARE_TRANSPARENT _ -> "Our data and product roadmap are\ntransparent for all."
        ...
        YATRI_COINS_STR -> "Yatri Coins"
        INTRODUCING_YATRI_COINS -> "Introducing Yatri Coins"
        NOW_EARN_COINS_FOR_EVERY_RIDE_AND_REFERRAL_AND_USE_THEM_TO_GET_REWARDS _ -> "Now earn coins for every ride and referral, and use them to get rewards"
        PAID_BY_YATRI_COINS -> "paid by Yatri Coins"
        YATRI_COINS_USAGE_POPUP _ -> "Yatri Coins will be converted into discounts that you can avail against your subscription plan."
        USE_COINS_NOW -> "Use Coins Now"
        BUY_NOW -> "Buy Now"
        SELECT_DATE -> "Select Date"
        WHAT_WILL_MY_COINS_BE_CONVERTED_TO -> "What will my Coins be converted to?"
        COINS_EXPIRING_IN_THE_NEXT -> "{} coins expiring in the next {} days. \n Use them before they expire"
        ...
        EARN_COINS_BY_TAKING_RIDES_AND_REFERRING_THE_APP_TO_OTHERS _ -> "Earn coins by taking rides and referring\nthe app to others"
        ...
        YATRI_COINS_FAQS -> "Yatri Coins FAQs"
        LEARN_ABOUT_YATRI_COINS -> "Learn about Yatri Coins"
        YATRI_COINS_FAQS_QUES1 _ -> "What are Yatri Coins?"
        YATRI_COINS_FAQS_QUES1_ANS1 _ -> "Yatri Coins are the rewards you earn on day-to-day activities on Namma Yatri like rides, referrals, good ratings, etc."
        YATRI_COINS_FAQS_QUES1_ANS2 _ -> "The earned coins can be used to avail discounts (Example: discounts in purchasing subscription plans using coins)"
        YATRI_COINS_FAQS_QUES1_ANS3 _ -> "Each Yatri Coin can be converted to a discount of Rs. 0.10 and can be used for availing discounts on subscription plans. More avenues to avail discounts will be added in the future"
        YATRI_COINS_FAQS_QUES2 _ -> "What is the validity of Yatri Coins?"
        YATRI_COINS_FAQS_QUES2_ANS1 days -> "Yatri Coins are valid for a period of "<> days <>" days from the day they are earned. During this period, you can use the coins for availing benefits."
        YATRI_COINS_FAQS_QUES2_ANS2 days -> "Yatri Coins not redeemed within "<> days <>" days stand forfeited"
        YATRI_COINS_FAQS_QUES3 _ -> "How can I earn Yatri Coins?"
        YATRI_COINS_FAQS_QUES3_ANS1 _ -> "Coins are earned through day-to-day activities on the app like taking rides, referring customers. You don’t need to do anything different."
        YATRI_COINS_FAQS_QUES3_ANS2 _ -> "You can earn more coins by exhibiting good behavior like low cancellations, getting good ratings from customers, etc."
        YATRI_COINS_FAQS_QUES4 _ -> "How can I use the Yatri Coins I earned?"
        YATRI_COINS_FAQS_QUES4_ANS1 _ -> "You can use the earned coins to purchase subscription plans free-of-cost within the validity period."
        YATRI_COINS_FAQS_QUES4_ANS2 _ -> "In the future, more options will be added for using Yatri Coins."
        YATRI_COINS_FAQS_QUES4_ANS3 _ -> "Yatri Coins cannot be used for any other purpose other than availing discounts"
        YATRI_COINS_FAQS_QUES5 _ -> "What is the eligibility to earn and use Yatri Coins?"
        YATRI_COINS_FAQS_QUES5_ANS1 _ -> "You must complete your first ride with Namma Yatri to start earning Yatri Coins."
        YATRI_COINS_FAQS_QUES5_ANS2 _ -> "The Yatri Coins section will be disabled until you complete your first ride."
        YATRI_COINS_FAQS_QUES6 _ -> "How many coins do I gain or lose for various actions?"
        YATRI_COINS_FAQS_QUES6_ANS1 _ -> "Coins are gained or lost for various actions based on the following table:"
        ...
        KNOW_ABOUT_COINS -> "Know about coins"
        ...
        RIDE_TOLL_FARE_INCLUDES -> "Toll charges included"
        ...
        TAKE_TWO_MORE_RIDES_TO_EARN_COINS coinValue -> "Take 2 more rides to earn " <> coinValue <> " coins"
        ONE_MORE_RIDE_TO_GO -> "1 more ride to go"
        TAKE_ONE_MORE_RIDE_TO_EARN_COINS coinValue -> "Take 1 more ride to earn " <> coinValue <> " coins"
        CONGRATULATIONS -> "Congratulations"
        YOU_HAVE_EARNED_COINS_FOR_COMPLETING_EIGHT_RIDES coinValue -> "You have earned " <> coinValue <> " Yatri Coins for completing 8 rides today"
        REFER_NAMMA_YATRI_APP_TO_CUSTOMERS_AND_EARN_COINS _ -> "Refer Namma Yatri app to customers and earn coins"
        REFER_NOW -> "Refer Now"
        ...
        LIMITED_TIME_OFFER_UNTIL_JUNE_30 -> "Limited time offer until June 30"
        ONLY_3_MORE_RIDES_FOR_100_COINS -> "Only 3 more rides for 100 coins"
        ...
        PLEASE_ENTER_A_VALID_EMAIL -> "Your email ID"
