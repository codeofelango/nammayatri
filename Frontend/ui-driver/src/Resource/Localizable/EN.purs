...
getEN stringKey =
    case stringKey of
        ...
        CUSTOMER_PAYS_DIRECTLY -> "Customer pays to you directly"
        ...
        YATRI_COINS_FAQS_QUES1 -> "What are Yatri Coins?"
        YATRI_COINS_FAQS_QUES1_ANS1 -> "Yatri Coins are the rewards you earn on day-to-day activities on Namma Yatri like rides, referrals, good ratings, etc."
        YATRI_COINS_FAQS_QUES1_ANS2 -> "The earned coins can be used to avail discounts (Example: discounts in purchasing subscription plans using coins)"
        YATRI_COINS_FAQS_QUES1_ANS3 -> "Each Yatri Coin can be converted to a discount of Rs. 0.10 and can be used for availing discounts on subscription plans. More avenues to avail discounts will be added in the future"
        YATRI_COINS_FAQS_QUES2 -> "What is the validity of Yatri Coins?"
        YATRI_COINS_FAQS_QUES2_ANS1 -> "Yatri Coins are valid for a period of 90 days from the day they are earned. During this period, you can use the coins for availing benefits."
        YATRI_COINS_FAQS_QUES2_ANS2 -> "Yatri Coins not redeemed within 90 days stand forfeited"
        YATRI_COINS_FAQS_QUES3 -> "How can I earn Yatri Coins?"
        YATRI_COINS_FAQS_QUES3_ANS1 -> "Coins are earned through day-to-day activities on the app like taking rides, referring customers. You don’t need to do anything different."
        YATRI_COINS_FAQS_QUES3_ANS2 -> "You can earn more coins by exhibiting good behavior like low cancellations, getting good ratings from customers, etc."
        YATRI_COINS_FAQS_QUES4 -> "How can I use the Yatri Coins I earned?"
        YATRI_COINS_FAQS_QUES4_ANS1 -> "You can use the earned coins to purchase subscription plans free-of-cost within the validity period."
        YATRI_COINS_FAQS_QUES4_ANS2 -> "In the future, more options will be added for using Yatri Coins."
        YATRI_COINS_FAQS_QUES4_ANS3 -> "Yatri Coins cannot be used for any other purpose other than availing discounts"
        YATRI_COINS_FAQS_QUES5 -> "What is the eligibility to earn and use Yatri Coins?"
        YATRI_COINS_FAQS_QUES5_ANS1 -> "You must complete your first ride with Namma Yatri to start earning Yatri Coins."
        YATRI_COINS_FAQS_QUES5_ANS2 -> "The Yatri Coins section will be disabled until you complete your first ride."
        YATRI_COINS_FAQS_QUES6 -> "How many coins do I gain or lose for various actions?"
        YATRI_COINS_FAQS_QUES6_ANS1 -> "Coins are gained or lost for various actions based on the following table:"
