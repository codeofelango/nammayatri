...
getML stringKey =
    case stringKey of
        ...
        SEVEN_DAY_FREE_TRIAL_ACTIVATED days -> days <> " ദിവസത്തെ സൗജന്യ ട്രയൽ സജീവമാക്കി!"
        TAKE_UNLIMITED_RIDES_FOR_THE_NEXT_SEVEN_DAYS days ->  "ആദ്യത്തെ " <> days <> " ദിവസത്തേക്ക് പരിധിയില്ലാത്ത റൈഡുകൾ എടുക്കുക"
        ...
        FREE_TRIAL_REMINDER days ->  "ദിവസം " <> days <> ": സൗജന്യ ട്രയൽ റിമൈൻഡർ"
        PLAN_STARTS days ->  "ദിവസം " <> days <> ": പ്ലാൻ ആരംഭിക്കുന്നു"
        ...
        YATRI_COINS_FAQS_QUES2_ANS1 _ -> "യാത്രി നാണയങ്ങൾ സമ്പാദിച്ച ദിവസം മുതൽ 90 ദിവസത്തേക്ക് സാധുതയുള്ളതാണ്. ഈ കാലയളവിൽ, ആനുകൂല്യങ്ങൾ ലഭിക്കുന്നതിന് നിങ്ങൾക്ക് നാണയങ്ങൾ ഉപയോഗിക്കാം."
        YATRI_COINS_FAQS_QUES2_ANS2 _ -> "90 ദിവസത്തിനുള്ളിൽ വീണ്ടെടുക്കാത്ത യാത്രി നാണയങ്ങൾ കണ്ടുകെട്ടി"
